namespace Interface.View
{
    public partial class VisualizarFuncionario : Form
    {
        ...
        private Funcionarios.TelaFuncionarios funcionarios;

        public VisualizarFuncionario(string matricula, string usuario, Funcionarios func)
        {
            InitializeComponent();
            InitializeTabOrder();
        ...
        public VisualizarFuncionario(string? matricula, string text, Funcionarios.TelaFuncionarios funcionarios)
        {
