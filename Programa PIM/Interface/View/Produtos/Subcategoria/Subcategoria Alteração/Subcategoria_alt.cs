...
{
    public partial class Subcategoria_alt : Form
    {
        private AlterarProduto formPrincipal;

        public Subcategoria_alt(AlterarProduto altProd)
        {
            InitializeComponent();
            InitializeTabOrder();
            formPrincipal = altProd;
        }
        ...
        private CadastrarSubcategoria_alt cadastro;
        private AlterarSubcategoria_alt alterar;
        ...
        private void bttIncluir_Click(object sender, EventArgs e)
        {
            ...
            CadastrarSubcategoria_alt telaCadastroSubcategoria = new CadastrarSubcategoria_alt(cod, this);
        ...
        private void bttAlterar_Click(object sender, EventArgs e)
        {
            if (dataGridSubcategoria.SelectedRows.Count == 1)
            {
                ...
                AlterarSubcategoria_alt alterar_subcategoria = new AlterarSubcategoria_alt(cod, this);
