...
{
    partial class Subcategoria_alt
    {
        /// <summary>
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Subcategoria_alt));
            faixadaVerde = new Panel();
            bttFechar = new PictureBox();
            lblSubcategoria = new Label();
            panelicones = new Panel();
            dataGridSubcategoria = new DataGridView();
            ...
            ((System.ComponentModel.ISupportInitialize)dataGridSubcategoria).BeginInit();
            SuspendLayout();
            // 
            // faixadaVerde
            // 
            ...
            lblSubcategoria.Size = new Size(117, 31);
            lblSubcategoria.TabIndex = 0;
            lblSubcategoria.Text = "Categoria";
            // 
            // panelicones
            // 
            ...
            // 
            dataGridSubcategoria.ColumnHeadersHeightSizeMode = DataGridViewColumnHeadersHeightSizeMode.AutoSize;
            dataGridSubcategoria.Location = new Point(49, 183);
            dataGridSubcategoria.Name = "dataGridSubcategoria";
            dataGridSubcategoria.RowHeadersWidth = 51;
            dataGridSubcategoria.RowTemplate.Height = 29;
            dataGridSubcategoria.Size = new Size(566, 312);
            dataGridSubcategoria.TabIndex = 13;
            // 
            // bttIncluir
            // 
            ...
            checkListBusca.Items.AddRange(new object[] { "ID Categoria", "Descrição Categoria" });
        ...
        private DataGridView dataGridSubcategoria;
