...
namespace Interface.View.Produtos
{
    ...
    {
        public TelaProdutos(string Usuario)
        {
            InitializeComponent();
            InitializeTabOrder();
        ...
        private AlterarProduto alterar;
        private VisualizarProduto visualizar;
        ...
        public void AtualizarDataGridView()
        {
            ...
            dataGridView1.DataSource = acoes.AtualizarDataGrid();
        }
        ...
        private void bttBuscar_Click(object sender, EventArgs e)
        {
            ...
            {
                selectedItem = "id_categoria"; //  Aqui altera para pesquisar o código
            }
            ...
            {
                selectedItem = "desc_produto"; //  Aqui altera para pesquisar o código
            }
            ...
            dt = acoes.Buscar(pesquisa, selectedItem, "produtos", "id_categoria");
        ...
        {
            CadastrarProduto telaCadastroProduto = new CadastrarProduto(lblUsuario.Text, this);
        ...
        private void bttAlterar_Click(object sender, EventArgs e)
        {
            ...
            else if (dataGridView1.SelectedRows.Count == 1)
            {
                ...
                string id = selectedRow.Cells["id_produto"].Value.ToString();

                AlterarProduto telaAlterar = new AlterarProduto(id, lblUsuario.Text, this);
                telaAlterar.Show();
            }
            else
            {
        ...
        private void bttVisualizar_Click(object sender, EventArgs e)
        {
            ...
            else if (dataGridView1.SelectedRows.Count == 1)
            {
                ...
                VisualizarProduto telaViualizar = new VisualizarProduto(id, lblUsuario.Text, this);
                telaViualizar.Show();
            }
            else
            {
                MessageBox.Show("Selecione um produto para visualizar.");
            }
        }
