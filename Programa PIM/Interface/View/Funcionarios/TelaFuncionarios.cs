...
namespace Interface.View.Funcionarios
{
    public partial class TelaFuncionarios : Form
    {
        ...
        private AlterarFuncionario alterar;
        private VisualizarFuncionario visualizar;

        public TelaFuncionarios(string Usuario)
        {
            InitializeComponent();
            InitializeTabOrder();
        ...
        public void AtualizarDataGridView()
        {
            ...
            dataGridView1.DataSource = acoes.AtualizarDataGrid("funcionarios", "matricula");
        }
        ...
        private void bttAlterar_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Selecione apenas um funcionário.");
            }
        ...
        private void bttVisualizar_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Selecione um funcionário para visualizar.");
            }
        }
        ...
        private void bttBuscar_Click(object sender, EventArgs e)
        {
            ...
            dt = acoes.Buscar(pesquisa, selectedItem, "funcionarios", "matricula");
