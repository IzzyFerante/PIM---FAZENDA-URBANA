...
{
    partial class AlterarCargo_AlterarFunc
    {
        /// <summary>
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(AlterarCargo_AlterarFunc));
            faixadaVerde = new Panel();
            bttFechar = new PictureBox();
            lblAlterarCargo = new Label();
            ...
            faixadaVerde.Controls.Add(lblAlterarCargo);
            ...
            // lblAlterarCargo
            // 
            lblAlterarCargo.AutoSize = true;
            lblAlterarCargo.BackColor = Color.DarkOliveGreen;
            lblAlterarCargo.FlatStyle = FlatStyle.System;
            lblAlterarCargo.Font = new Font("Segoe UI", 12F, FontStyle.Bold, GraphicsUnit.Point);
            lblAlterarCargo.ForeColor = SystemColors.ControlLightLight;
            lblAlterarCargo.Location = new Point(26, 20);
            lblAlterarCargo.Name = "lblAlterarCargo";
            lblAlterarCargo.Size = new Size(139, 28);
            lblAlterarCargo.TabIndex = 0;
            lblAlterarCargo.Text = "Alterar Cargo";
            // 
            // panelicones
            // 
            ...
            txtDescCargo.Location = new Point(279, 102);
            ...
            lblDescCargo.Location = new Point(190, 105);
            lblDescCargo.Name = "lblDescCargo";
            lblDescCargo.Size = new Size(83, 23);
            lblDescCargo.TabIndex = 17;
            lblDescCargo.Text = "Descrição";
            // 
            // bttCancelar
            // 
            ...
            Name = "AlterarCargo_AlterarFunc";
            StartPosition = FormStartPosition.CenterScreen;
            Text = "AlterarCargo";
            Load += AlterarCargo_AlterarFunc_Load;
