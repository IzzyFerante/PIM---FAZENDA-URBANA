...
{
    public partial class Cargo_AlterarFunc : Form
    {
        private AlterarFuncionario formPrincipal;
        private AlterarCargo_AlterarFunc alterarCargo;
        private CadastroCargo_AlterarFunc cadastrarCargo;

        public Cargo_AlterarFunc(AlterarFuncionario cadastroFunc)
        {
            InitializeComponent();
            InitializeTabOrder();
        ...
        private void Cargo_AlterarFunc_FormClosed(object sender, FormClosedEventArgs e)
        {
        ...
        private void bttIncluir_Click(object sender, EventArgs e)
        {
            ...
            CadastroCargo_AlterarFunc telaCadastroCargo = new CadastroCargo_AlterarFunc(cod, this);
        ...
        private void bttAlterar_Click(object sender, EventArgs e)
        {
            if (dataGridCargos.SelectedRows.Count > 0)
            {
                ...
                AlterarCargo_AlterarFunc alterar_cargo = new AlterarCargo_AlterarFunc(cod, this);
                alterar_cargo.Show();
            }
            else
            {
