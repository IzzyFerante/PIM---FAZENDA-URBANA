...
{
    public partial class VisualizarCliente_alt : Form
    {
        private AlterarVenda formPrincipal;

        public VisualizarCliente_alt(AlterarVenda alterar)
        {
            InitializeComponent();
            InitializeTabOrder();
        ...
        public void AtualizarDataGridView()
        {
            ...
            dataGridView.DataSource = acoes.AtualizarDataGridATIVOS("clientes", "id_cliente");
        }
        ...
        private void bttBuscar_Click(object sender, EventArgs e)
        {
            ...
            if (selectedItem == "id cliente")
            {
                selectedItem = "id_cliente";
            }
            else if (selectedItem == "email")
            {
                pesquisa = txtPesquisa.Text.ToLower();
            }
        ...
        private void bttSelecionar_Click(object sender, EventArgs e)
        {
            if (dataGridView.SelectedRows.Count == 1)
            {
                ...
                string cod = selectedRow.Cells["id_cliente"].Value.ToString();

                formPrincipal.SetClienteCode(cod);
                this.Close();
            }
