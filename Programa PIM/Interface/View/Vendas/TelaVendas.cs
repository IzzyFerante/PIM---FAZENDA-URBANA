...
namespace Interface.View.Vendas
{
    public partial class TelaVendas : Form
    {
        ...
        private CadastrarVenda cadastro;
        private AlterarVenda alterar;
        private VisualizarVenda visualizar;
        ...
        public void AtualizarDataGridView()
        {
            ...
            dataGridView1.DataSource = acoes.AtualizarDataGrid("vendas", "id_venda");
        }
        ...
        private void bttBuscar_Click(object sender, EventArgs e)
        {
            ...
            if (selectedItem == "id venda")
            {
                selectedItem = "id_venda"; //  Aqui altera para pesquisar o código
                dt = acoes.Buscar(pesquisa, selectedItem, "vendas", "id_venda");
            }
            else if (selectedItem == "id cliente")
            {
                selectedItem = "id_cliente"; //  Aqui altera para pesquisar o código
                dt = acoes.Buscar(pesquisa, selectedItem, "vendas", "id_venda");
            }
            else if (selectedItem == "forma de pagamento")
            {
                selectedItem = "forma_pagamento"; //  Aqui altera para pesquisar o código
        ...
        {
            CadastrarVenda telaCadastroVenda = new CadastrarVenda(lblUsuario.Text, this);
            telaCadastroVenda.Show();
        }
        ...
        private void bttAlterar_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Selecione apenas uma venda.");
            }
            else if (dataGridView1.SelectedRows.Count == 1)
            {
                var selectedRow = dataGridView1.SelectedRows[0];
                string id = selectedRow.Cells["id_venda"].Value.ToString();

                AlterarVenda telaAlterar = new AlterarVenda(id, lblUsuario.Text, this);
                telaAlterar.Show();
            }
            else
            {
        ...
        private void bttVisualizar_Click(object sender, EventArgs e)
        {
            ...
            else if (dataGridView1.SelectedRows.Count == 1)
            {
                ...
                VisualizarVenda telaViualizar = new VisualizarVenda(id, lblUsuario.Text, this);
                telaViualizar.Show();
            }
            else
            {
