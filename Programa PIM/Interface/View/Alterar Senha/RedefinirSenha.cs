...
namespace Interface.View
{
    public partial class RedefinirSenha : Form
    {
        ...
        {
            MessageBox.Show("Coloque o seu email cadastrado no sistema!\n\nCaso não se lembre, favor contatar seu Superior", "Ajuda Usuário", MessageBoxButtons.OK, MessageBoxIcon.Information);
        }
        ...
        private void bttConfirmar_Click(object sender, EventArgs e)
        {
            ...
            string palavraChave = txtPalavraChave.Text.ToUpper();
            int result = acoesLogin.RedefinirSenha(txtEmail.Text, palavraChave);
            ...
            {
                MessageBox.Show("Email ou Palavra de Segurança incorretos!\n\nVerifique as letras maiúsculas ou minúsculas.", "Dados incorretos", MessageBoxButtons.OK, MessageBoxIcon.Asterisk);
            }
        }
