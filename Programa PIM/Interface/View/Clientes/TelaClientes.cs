...
namespace Interface.View.Clientes
{
    ...
    {
        private CadastrarCliente cadastro;
        private AtualizarCliente alterar;
        private VisualizarCliente visualizar;

        public TelaClientes(string Usuario)
        {
            InitializeComponent();
            InitializeTabOrder();
        ...
        public void AtualizarDataGridView()
        {
            ...
            dataGridView1.DataSource = acoes.AtualizarDataGrid("clientes", "id_cliente");
        }
        ...
        private void bttBuscar_Click(object sender, EventArgs e)
        {
            ...
            dt = acoes.Buscar(pesquisa, selectedItem, "clientes", "id_cliente");
        ...
        {
            CadastrarCliente telaCadastroCliente = new CadastrarCliente(lblUsuario.Text, this);
        ...
        private void bttAlterar_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Selecione apenas um cliente.");
            }
            else if (dataGridView1.SelectedRows.Count == 1)
            {
                var selectedRow = dataGridView1.SelectedRows[0];
                string idCliente = selectedRow.Cells["id_cliente"].Value.ToString();

                AtualizarCliente alterar_cliente = new AtualizarCliente(idCliente, lblUsuario.Text, this);
        ...
        private void bttVisualizar_Click(object sender, EventArgs e)
        {
            ...
            else if (dataGridView1.SelectedRows.Count == 1)
            {
                ...
                VisualizarCliente visualizar_cliente = new VisualizarCliente(idCliente, lblUsuario.Text, this);
