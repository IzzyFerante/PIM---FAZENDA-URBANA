...
{
    public partial class TelaArea_cad : Form
    {
        private CadastrarProducao formPrincipal;

        private AlterarArea_cad alterar;
        private CadastrarArea_cad cadastrar;

        public TelaArea_cad(CadastrarProducao cadastro)
        {
            InitializeComponent();
            InitializeTabOrder();
        ...
        private void bttIncluir_Click(object sender, EventArgs e)
        {
            ...
            CadastrarArea_cad cadastrarArea = new CadastrarArea_cad(novoID, this);
        }
        ...
        private void bttAlterar_Click(object sender, EventArgs e)
        {
            if (dataGridCargos.SelectedRows.Count == 1)
            {
                ...
                AlterarArea_cad alterar_cargo = new AlterarArea_cad(cod, this);
                alterar_cargo.Show();
            }
