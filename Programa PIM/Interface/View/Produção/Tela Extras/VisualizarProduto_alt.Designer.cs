namespace Interface.View.Produção.Tela_Extras
{
    partial class VisualizarProduto_alt
    {
        /// <summary>
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(VisualizarProduto_alt));
            ...
            lblSubcategoria.Size = new Size(112, 31);
            lblSubcategoria.TabIndex = 0;
            lblSubcategoria.Text = "Produtos";
            // 
            // panelicones
            // 
            ...
            checkListBusca.Items.AddRange(new object[] { "ID Categoria", "ID Produto", "Descrição Produto" });
            checkListBusca.Location = new Point(385, 165);
            checkListBusca.Name = "checkListBusca";
            checkListBusca.Size = new Size(198, 70);
