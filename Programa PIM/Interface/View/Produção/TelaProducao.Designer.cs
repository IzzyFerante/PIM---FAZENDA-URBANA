namespace Interface.View.Produção
{
    partial class TelaProducao
    {
        ...
        private void InitializeComponent()
        {
            ...
            lblClientes.Size = new Size(173, 46);
            lblClientes.TabIndex = 18;
            lblClientes.Text = "Produção";
            // 
            // picVoltar
            // 
            ...
            // picIcone
            // 
            picIcone.Image = Properties.Resources.output_onlinepngtools__7_;
            ...
            checkListBusca.Items.AddRange(new object[] { "ID Produção", "ID Produto", "Área" });
