...
using Interface.View.Produção.Tela_Extras;
using Interface.View.Produção.Tela_Extras.Area.Area_cad;

namespace Interface.View.Produção
{
    public partial class CadastrarProducao : Form
    {
        private TelaProducao formPrincipal;


        public CadastrarProducao(string usuario, TelaProducao prod)
        {
            InitializeComponent();
            InitializeTabOrder();
        ...
        private TelaArea_cad area;
        private Tela_Extras.VisualizarProduto_cad produto;
        ...
        /// 
        private void CadastrarProducao_Load(object sender, EventArgs e)
        {
            AcoesFuncionarios acoes = new AcoesFuncionarios();

            string ultimoId = acoes.NovaMatricula("producao", "id_producao");
            ...
            txtIdProducao.Text = novaMatricula;
        }
        ...
        private void bttConfirmar_Click(object sender, EventArgs e)
        {
            ...
            if (ValidarCamposObrigatorios() && ValidarCamposObrigatoriosData() && ValidarCamposObrigatoriosDataColheita())
            {
                ...
                acoes.CadastrarDados(txtIdProducao.Text, txtCodProduto.Text, dtPlantio, dtColheita, txtQntdPlantada.Text, txtArea.Text);
        ...
        {
            TelaArea_cad telaArea = new TelaArea_cad(this);
            telaArea.Show();
        }

        private void picBuscaProduto_Click(object sender, EventArgs e)
        {
            Tela_Extras.VisualizarProduto_cad telaProduto = new Tela_Extras.VisualizarProduto_cad(this);
            telaProduto.Show();
        }
